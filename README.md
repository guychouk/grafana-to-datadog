...
It uses a PromQL parser generated from [this project](https://github.com/guychouk/promql-parser) to parse the PromQL queries in the panels and convert them to Datadog queries.
